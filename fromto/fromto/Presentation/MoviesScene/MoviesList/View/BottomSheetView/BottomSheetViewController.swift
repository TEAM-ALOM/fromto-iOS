...
class BottomSheetViewController: UIViewController{
    ...
    lazy var timeStackView: UIStackView = {
        let st = UIStackView(arrangedSubviews: [timeButton("오전 --:--"),imageView("arrow.right"),timeButton("오후 --:--")])
        st.axis = .horizontal
        st.distribution = .equalSpacing
        st.alignment = .center
        st.spacing = 13
    ...
    func addSubView(){
        [bottomSheetView, spaceLabel, line, timeLabel, buttonStackView, dayLabel, timeStackView, findButton].forEach {
            view.addSubview($0)
        }
    }
    ...
    func autoLayoutView() {
        ...
        NSLayoutConstraint.activate([
            ...
            line.topAnchor.constraint(equalTo: spaceLabel.bottomAnchor, constant: 16),
            line.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 24),
            
            dayLabel.topAnchor.constraint(equalTo: line.bottomAnchor, constant: 11),
            ...
            timeLabel.topAnchor.constraint(equalTo: buttonStackView.bottomAnchor, constant: 23),
            timeLabel.leadingAnchor.constraint(equalTo: self.view.leadingAnchor, constant: 24),
            
            timeStackView.topAnchor.constraint(equalTo: timeLabel.bottomAnchor, constant: 7),
